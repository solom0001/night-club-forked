...
const MusicListCarousel = ({
  ...
  const mobileOffset = current * ITEM_WIDTH;

  return (
    <div>
      <div className="hidden lg:flex full-bleed items-center justify-center gap-6">
        <button
          onClick={prev}
      ...
      <div className="lg:hidden full-bleed flex flex-col items-center">
        <div className="relative overflow-hidden" style={{ width: ITEM_WIDTH }}>
          <div
              ...
              return (
                ...
                >
                  <div className="relative w-[288px] h-[264px] grid">
                    ...
                    {isActive && (
                      <div className="absolute inset-0 grid overflow-hidden">
                        <h2 className="uppercase text-[20px]! text-center mt-auto h-[4rem] py-2 w-full bg-black/90">
                          {song.title}
                        </h2>

                        <img
                          src="/assets/icon/Playing.svg"
                          className="h-[52px] w-[52px] rounded-full border-5 border-(--red)
                               absolute top-[40%] left-[40%]"
                        />

                        <span className="w-[84px] h-[84px] bg-(--red) absolute rotate-45 bottom-[-42px] right-[-42px]" />
                        <span className="w-[84px] h-[84px] bg-(--red) absolute rotate-45 top-[-42px] left-[-42px]" />
                      </div>
                    )}
                  </div>
                </div>
