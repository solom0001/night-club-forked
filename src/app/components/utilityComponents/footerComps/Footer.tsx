    ...
    >
      <div className="m-8 flex flex-col lg:gap-32 gap-12">
        <div className="flex flex-col lg:grid lg:grid-cols-[1fr_2fr] gap-12">
          ...
          <div className="hidden lg:grid grid-cols-2 gap-8">
            ...
            <div className="flex flex-col gap-12">
              <h2>Recent tweets</h2>
              <Recents
                desc="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla non rutrum felis."
                image="/assets/bg/header_bg_1.jpg"
              />
              <Recents
                desc="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla non rutrum felis."
                image="/assets/bg/header_bg_1.jpg"
        ...
        <div className="flex flex-col items-center gap-4 lg:flex-row lg:items-end text-center lg:text-start">
          <p className="flex-1 order-2 lg:order-1">
          ...
          <p className="flex-1 text-end order-3 lg:order-3">
            Copyright © NightClub
          </p>
        </div>
      </div>
